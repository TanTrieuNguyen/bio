!(function lanyard() {
    const userID = "1068811765976141834";
    const elements = {
    ...
    const statusColorMap = {
        online: { color: "#23a55a", text: "Trá»±c tuyáº¿n", glow: "0 0 5px 2px #23a55a" },
        dnd: {
            color: "#f23f43",
            text: "KhĂ´ng lĂ m phiá»n",
            glow: "0 0 5px 2px #f23f43",
        },
        idle: { color: "#f0b232", text: "NhĂ n rá»—i / AFK", glow: "0 0 5px 2px #f0b232" },
